...
class Benchmark {
  ...
  private static void SearchBenchmarks() {
    ...
    Mark7("linear_search_success", i -> SearchAndSort.linearSearch(successItem, intArray));
    Mark7("binary_search_success", i -> SearchAndSort.binarySearch(successItem, intArray));
  }
  ...
  private static void SearchScalabilityBenchmarks1() {
    for (int size = 100; size <= 10_000_000; size *= 2) {
      ...
      Mark8("binary_search_success", String.format("%8d", size),
  ...
  private static void SearchScalabilityBenchmarks2() {
    for (int size = 100; size <= 10_000_000; size *= 2) {
      ...
      Mark8("binary_search_success", String.format("%8d", size), i -> {
  ...
  private static void GetPseudorandomItems() {
    for (int size = 100; size <= 10_000_000; size *= 2) {
      ...
      final int n = size;
      SearchAndSort.shuffle(items);
      Mark8("get_pseudorandom_items", String.format("%8d", size), i -> {
        int successItem = items[i % n];
        return successItem;
      });
    }
  ...
  private static void SortingBenchmarks() {
    ...
    Mark8Setup("shuffle", new Benchmarkable() {
      public double applyAsDouble(int i) {
        SearchAndSort.shuffle(intArray);
        return 0.0;
      }
    });
    Mark8Setup("selection_sort", new Benchmarkable() {
      public void setup() {
        SearchAndSort.shuffle(intArray);
      }
    ...
    Mark8Setup("quicksort", new Benchmarkable() {
      public void setup() {
        SearchAndSort.shuffle(intArray);
      }
    ...
    Mark8Setup("heapsort", new Benchmarkable() {
      public void setup() {
        SearchAndSort.shuffle(intArray);
      }
  ...
  private static void SortingScalabilityBenchmarks() {
    for (int size = 100; size <= 50000; size *= 2) {
      ...
      Mark8Setup("selection_sort", String.format("%8d", size), new Benchmarkable() {
        public void setup() {
          SearchAndSort.shuffle(intArray);
        }
    ...
    for (int size = 100; size <= 2000000; size *= 2) {
      final int[] intArray = SearchAndSort.fillIntArray(size);
      Mark8Setup("quicksort", String.format("%8d", size), new Benchmarkable() {
        public void setup() {
          SearchAndSort.shuffle(intArray);
        }
    ...
    for (int size = 100; size <= 2000000; size *= 2) {
      final int[] intArray = SearchAndSort.fillIntArray(size);
      Mark8Setup("heapsort", String.format("%8d", size), new Benchmarkable() {
        public void setup() {
          SearchAndSort.shuffle(intArray);
        }
