...
public class TestWordStream {
  public static void main(String[] args) throws Exception {
    ...
    String fileName = "/home/perlt/dev/school/runablePCPP/week05/code-exercises/week05exercises/english-words";
    ...
    // real 0m3.734s
    // System.out.println(streamSupplier.get().parallel().map(TestWordStream::letters)
    //     .collect(Collectors.groupingByConcurrent(e -> e)).values().stream().filter(e -> e.size() > 1).count()); // Use groupingByConcurrent to increase speed 
